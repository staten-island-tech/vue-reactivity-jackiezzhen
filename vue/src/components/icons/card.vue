<template>
    <div class="card">
        ...
        <div class="path_container"><img class="path" :src="`../Path_${character.path}.webp`" :alt="`${character.path}`" />
        <p>Path: {{ character.path }}</p></div>
        <div class="type_container"><img class="type" :src="`../Type_${character.type}.webp`" :alt="`${character.type}`" />
